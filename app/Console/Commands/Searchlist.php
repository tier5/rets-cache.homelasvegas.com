...
class Searchlist extends Command
{
     ...
     * @var string
     */
    protected $signature = 'store:searchresult';
     ...
     * @var string
     */
    protected $description = 'Get result by api call and store into database';
    ...
    public function handle()
    {
        ...
        if($connect)
        {
            ...
            echo "Sorry!! Connection not able to establish.try after sometime";
        }
    }
}
